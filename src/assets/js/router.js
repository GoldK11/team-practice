...
const Router = [
  ...
  {
    path: CONST.ROUTER.PATH.WHAT,
    component: NotFound,
    name: CONST.ROUTER.NAME.WHAT,
    meta: { category: CONST.ROUTER.META.CATEGORY.MAIN, authorization: false },
  },
  {
    path: CONST.ROUTER.PATH.WHY,
    component: NotFound,
    name: CONST.ROUTER.NAME.WHY,
    meta: { category: CONST.ROUTER.META.CATEGORY.MAIN, authorization: false },
  },
  {
    path: CONST.ROUTER.PATH.HOW,
    component: NotFound,
    name: CONST.ROUTER.NAME.HOW,
    meta: { category: CONST.ROUTER.META.CATEGORY.MAIN, authorization: false },
  },
  {
  ...
  {
    path: CONST.ROUTER.PATH.LIST,
    component: List,
    name: CONST.ROUTER.NAME.LIST,
